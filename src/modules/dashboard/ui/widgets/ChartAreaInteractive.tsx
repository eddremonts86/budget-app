...
const LazyChartAreaInteractiveContent = React.lazy(() =>
  import('./ChartAreaInteractiveContent').then((module) => ({
    default: module.ChartAreaInteractiveContent,
  })),
)
    ...
    <Card className="@container/card">
      <CardHeader>
        ...
        <div className="flex items-center gap-2">
          ...
          <Select value={timeRange} onValueChange={setTimeRange}>
            ...
            >
              <SelectValue placeholder={t('chart.timeRange.placeholder')} />
            </SelectTrigger>
      ...
      <CardContent className="px-2 pt-4 sm:px-6 sm:pt-6">
        <React.Suspense fallback={<Skeleton className="h-62.5 w-full" />}>
          <LazyChartAreaInteractiveContent data={filteredData} chartConfig={chartConfig} />
        </React.Suspense>
      </CardContent>
    </Card>
  )
