...
import { TodoForm, TodoList } from '@/features/example-todo'
    ...
    <div className="min-h-screen">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-3xl mx-auto">
          ...
          {/* Create Form */}
          {showForm && (
            <div className="mb-8 p-6 rounded-lg border bg-card animate-in fade-in slide-in-from-top-2 duration-300">
