...
- Crear cliente en `src/shared/lib/rag/chroma-client.ts`.
...
- Configurar en `src/shared/lib/ai/server/providers.ts`.
...
- **Verificar:** `src/shared/lib/ai/server/providers.ts` debe tener el adaptador para "LM Studio" apuntando a `http://localhost:1234/v1`.
...
- Implementar lógica simple en `src/shared/lib/rag/context.ts`.
