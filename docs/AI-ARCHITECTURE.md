...
- La configuracion ahora se centraliza en `src/ai/config`.
- Los providers ahora se centralizan en `src/ai/providers`.
- RAG, storage y audit ahora viven en `src/ai/rag`, `src/ai/storage` y `src/ai/audit`.
